 ...
 *
 * @param organization  Group/organization ID (e.g., "org.typelevel")
 * @param name          Artifact name (e.g., "cats-core")
 * @param version       Version string (e.g., "2.13.0")
 * @param crossVersion  Whether to use Scala cross-versioning (%% in sbt)
 */
...
/**
 * Configuration model representing the HOCON config structure.
 * All fields are optional to allow partial configuration.
 *
 * @param name            Project name
 * @param organization    Organization/group ID
 * @param version         Project version
 * @param scalaVersion    Scala compiler version
 * @param scalacOptions   Scala compiler options
 * @param dependencies    Compile dependencies
...
object ProjectConfig {
  ...
  object Example {
    ...
    val scalacOptions = Seq("-deprecation", "-feature", "-unchecked")
